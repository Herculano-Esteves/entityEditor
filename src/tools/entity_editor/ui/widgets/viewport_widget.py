...
from src.tools.entity_editor.data import Entity, BodyPart, Hitbox, Vec2
...
class ViewportWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # New Components
        from src.tools.entity_editor.ui.viewport.viewport_controller import ViewportController
        from src.tools.entity_editor.ui.viewport.viewport_renderer import ViewportRenderer
